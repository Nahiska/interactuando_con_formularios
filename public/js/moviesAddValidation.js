...
//-------------------DE REGISTRO DE PELÍCULAS------------------//    
    ...
    title.addEventListener("blur", () => {
        switch (true) {
            case !title.value.trim():
                titleError.innerText = "Debes ingresar un título";
    ...
    rating.addEventListener("blur", () => {
        switch (true) {
            case !rating.value.trim():
                ratingError.innerText = "Debes ingresar el rating";
                rating.classList.remove("is-valid");
                rating.classList.add("is-invalid");
                break;
            case (rating.value < 0 || rating.value > 10):
                ratingError.innerText = 'El rating debe ser entre 0 y 10';
                rating.classList.remove("is-valid");
                rating.classList.add("is-invalid");
                break;
            default:
    ...
    awards.addEventListener("blur", () => {
        switch (true) {
            case !awards.value.trim():
                awardsError.innerText = "Debes ingresar la cantidad de Premios";
                awards.classList.remove("is-valid");
                awards.classList.add("is-invalid");
                break;
            case (awards.value < 0 || awards.value > 10):
                awardsError.innerText = 'El awards debe ser entre 0 y 10';
                awards.classList.remove("is-valid");
                awards.classList.add("is-invalid");
                break;
            default:
    ...
    release_date.addEventListener("blur", () => {
        switch (true) {
            case !release_date.value.trim():
                releaseError.innerText = "Debes ingresar su fecha de creación";
    ...
    length.addEventListener("blur", () => {
        switch (true) {
            case !length.value.trim():
                lengthError.innerText = "Debes ingresar la duración";
                length.classList.remove("is-valid");
                length.classList.add("is-invalid");
                break;
            case (length.value < 60 || length.value > 360):
                lengthError.innerText = 'La duración debe ser entre 60 y 360';
                length.classList.remove("is-valid");
                length.classList.add("is-invalid");
                break;
            default:
    ...
    genreID.addEventListener("blur", () => {
        switch (true) {
            case !genreID.value.trim():
                genreError.innerText = "Debes ingresar el género";
    ...
    form.addEventListener("submit", (event) => {
        ...
        let elementsWithErrors = document.querySelectorAll(".is-invalid");
        let errors = elementsWithErrors.length > 0;
